...
let context;
let upis = ['cryptomaster98@icici','cryptoboss@icici','9068052966@paytm','buythedip@icici']
    ...
    return (
      ...
      <Label style={{color:"black"}}>Enter your UPI</Label>
                ...
                if(this.state.sendername.length == 0 || this.state.senderupi == 0){
                  ...
                  axios({
                    method:"post",
                    url: `https://api.anteagle.tech/requestupi?upiid=${this.state.senderupi}&name=${this.state.sendername}&amount=${this.state.orig_amount}`,
                    headers:{
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e)=>{
              ...
              this.setState({final:parseFloat(e.target.value/this.state.amount).toFixed(10)})
            }}
